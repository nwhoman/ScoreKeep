...
let touchedBRNode = SKAction.sequence([scaleNode, vibrate, SKAction.wait(forDuration: 1.0), unscaleNode])
let touchedFieldNode = SKAction.sequence([SKAction.group([scaleNode, colorBlack]), vibrate, SKAction.wait(forDuration: 1.0), SKAction.group([unscaleNode, colorWhite])])
